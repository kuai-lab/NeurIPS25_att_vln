...
from .agent_base_atena import Seq2SeqAgent
...
class GMapNavAgent(Seq2SeqAgent):
    ...
    def rollout(self, train_ml=None, train_rl=False, reset=True):
        ...
        for t in range(self.args.max_action_len):
            ...
            q_dist = one_hot * self.args.r_lambda + \
                         nav_probs[0][mask] * (1-self.args.r_lambda)
        ...
        # ATENA adaptation
        self.end_of_episode(obs[0]['instr_id'], traj, obs[0], m_entropy, o_entropy, t+1)
