export PYTHONPATH=/home/heeju/workspace/Matterport3DSimulator/build:$PYTHONPATH
DATA_ROOT=../datasets
...
# test
CUDA_VISIBLE_DEVICES='0' python reverie/main_nav_obj_atena.py $flag  \
      --tokenizer bert \
      --resume_file ../datasets/REVERIE/trained_models/best_val_unseen \
      --test --lr_pre 5e-06 --lr_post 1e-07 --bin_weight 0.25 --r_lambda 0.5 --active_criteria 0.1