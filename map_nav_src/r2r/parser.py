...
def parse_args():
    ...
    parser.add_argument('--active_criteria', type=float, default=0.0)
    parser.add_argument('--lr_pre', type=float, default=1e-5)
    parser.add_argument('--lr_post', type=float, default=5e-7)
    parser.add_argument('--bin_weight', type=float, default=0.0)
    parser.add_argument('--r_lambda', type=float, default=0.0)
