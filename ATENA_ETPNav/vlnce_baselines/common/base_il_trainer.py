...
class BaseVLNCETrainer(BaseILTrainer):
    ...
    def eval(self, active_criteria=0.05, lr_pre=1e-6, lr_post=1e-7, bin_weight=0.1, r_lambda=0.5):
        ...
        with TensorboardWriter(
            ...
            if os.path.isfile(self.config.EVAL.CKPT_PATH_DIR):
                ...
                self._eval_checkpoint(
                    ...
                    active_criteria=active_criteria, lr_pre=lr_pre, lr_post=lr_post, bin_weight=bin_weight, r_lambda=r_lambda
                )
            else:
